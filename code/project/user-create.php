...
<div class="content_title">
	<span><?php echo CURRENT_LOCATION ?>： <a  href="project-list.php"><?php echo PROJECT_MANAGEMENT ?></a> > <a  href="user-list.php?formProjectId=<?php echo $_GET['formProjectId']?>&code=<?php echo $_GET['code']?>"><?php echo $_GET['code']?></a>  > <?php echo CREATE_ACCOUNT ?></span>
</div>
  	...
  	<div class="creat_text_left">
 		 <ul>
    			...
    			<li><?php echo PRJ_NAME ?></li>
        			<li><?php echo USER_EMPCODE ?></li>
         			<li> <?php echo USER_PASSWORD_OLD ?></li>
   	...
   	<div class="creat_text_right">
  		...
  		<ul>
		    	...
		    	<form id="test" method="post"   action="data/user.create.php" enctype="multipart/form-data"   class="easyui-form" ><input id="projectId" type="hidden" name="project_id" value="<?php echo $_GET['formProjectId']?>">
		    	<li><input class="easyui-validatebox textbox" type="text"  name="user_empcode" id="userEmpcode"   style="width:288px;height:36px;" data-options="required:true,validType:'repeat'"  missingMessage="<?php echo MISS_USER_EMPCODE ?>"><span  style="color: red">*</span></li>
		    	<li><input class="easyui-validatebox textbox" type="text"  name="" id="" value='123456'  style="width:288px;height:36px;"  readOnly="true"  data-options="required:true"  missingMessage="<?php echo MISS_PRJ_SN ?>"><span  style="color: red">*</span></li>
		    	<li >
...
<script type="text/javascript" src="js/user-create.js?v=<?php echo $JS_VERSION;?>"></script>
</body>
</html>
