...
<div class="content_title">
	<span><?php echo CURRENT_LOCATION ?>： <a  href="project-list.php"><?php echo PROJECT_MANAGEMENT ?></a> > <?php echo UPDATE_PRJ ?></span>
</div>
...
<div class="creat_text">
  	<div class="creat_text_left">
   	...
   	<div class="creat_text_right">
   		<form id="test" method="post"   action="data/project.update.php" enctype="multipart/form-data"   class="easyui-form" > <input id="projectId" type="hidden" name="project_id" value="<?php echo $_GET['formProjectId']?>">
  		<ul>
		    	<li><input class="easyui-validatebox textbox" type="text"  name="project_code" id="projectCode"   style="width:288px;height:36px;"  data-options="required:true"  missingMessage="<?php echo MISS_PRJ_SN ?>"><span  style="color: red">*</span></li>
...
<script type="text/javascript" src="js/project-update.js?v=<?php echo $JS_VERSION;?>"></script>
</body>
</html>
