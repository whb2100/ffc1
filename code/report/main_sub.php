<html>
    ...
    <body>
                     <span style="margin-left: 5px;"><?php echo CURRENT_START_TIME ?>：</span><input class="easyui-datebox" type="text" style="width:145px;height:36px" name="start_date" id="startDate"   editable="false">
                      <span style="margin-left: 5px;"><?php echo CURRENT_TYPE ?>：</span><input class="easyui-combobox" style="width: 120px;height:36px" id="ifMixed" data-options="valueField:'value',textField:'text',data:[{'value':'0','text':'<?php echo CURRENT_TYPE_MIX ?>'},{'value':'1','text':'<?php echo CURRENT_TYPE_NO ?>'}]"> 
                      <span style="margin-left: 5px;"><?php echo CURRENT_TYPE_VIEW ?>：</span><input class="easyui-combobox" style="width: 120px;height:36px" id="view" >
                    <div class="xmys_right_button">
	    	<ul>  
                              <li class="xmys_button_download"  style="margin-top: -10px;"><a href="javascript:void(0)" onclick="saveView()"><?php echo CURRENT_TYPE_VIEW_SAVE?></a></li>
                              <li class="xmys_button_download"  style="margin-top: -10px;"><a href="javascript:void(0)" onclick="delView()"><?php echo CURRENT_TYPE_VIEW_DEL?></a></li>
    ...
    <div id="noMixDiv" style="display: none;width: 100%;"></div>
        ...
        <script type="text/javascript" src="js/main_sub.js?v=<?php echo $JS_VERSION;?>"></script>
    </body>
</html>