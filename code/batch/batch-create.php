<html>
    ...
    <body>
		...
		<div class="pcl_right_all">
			<div class="pcl_title" id="pcl_title_header"> <span style="margin-right:5px;padding-left:5px;" id="batch_title"><?php echo CURRENT_LOCATION?><span id="pName" style="font-size: 20px;"></span><?php echo TITLE_BATCH?></span><span id="showBatchCode" style="display: none;"></span>
				...
				<div class="pcl_title_right">
					<ul>
						...
						<input style="height: 23px; width: 100px;" class="easyui-validatebox textbox" type="text" id="batchInput"
				        ...
				        <li id="currencyIdLi" style="display: block;"> <span><?php echo BATCH_CURRENCY?></span>
							<select id="currencyId" style="width:120px;height:25px;"></select>
				        </li>
				        ...
				        <li>
					        ...
					        <div class="pocl_right_button_lishi" id="addBatchButton" style="display: none"> <a href="javascript:void(0)" onclick="addBatch()"><?php echo ADD_BATCH?></a></div>
				        </li>
        ...
        <script type="text/javascript" src="js/batch-create.js?v=<?php echo $JS_VERSION;?>"></script>
    </body>
</html>