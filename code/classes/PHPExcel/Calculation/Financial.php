...
class PHPExcel_Calculation_Financial {
	 ...
	 * This function is provided for the French accounting system. If an company is purchased in
	 * the middle of the accounting period, the prorated depreciation is taken into account.
	 * The function is similar to AMORLINC, except that a depreciation coefficient is applied in
	 * the calculation depending on the life of the companys.
	 * This function will return the depreciation until the last period of the life of the companys
	 * or until the cumulated value of depreciation is greater than the cost of the companys minus
	 * the salvage value.
	 *
	 * Excel Function:
	 ...
	 * @access	public
	 * @category Financial Functions
	 * @param	float	cost		The cost of the company.
	 * @param	mixed	purchased	Date of the purchase of the company.
	 * @param	mixed	firstPeriod	Date of the end of the first period.
	 * @param	mixed	salvage		The salvage value at the end of the life of the company.
	...
	public static function AMORDEGRC($cost, $purchased, $firstPeriod, $salvage, $period, $rate, $basis=0) {
		...
		//	Life of companys (1/rate)		Depreciation coefficient
		//	Less than 3 years			1
	 ...
	 * DB
	 *
	 * Returns the depreciation of an company for a specified period using the
	 ...
	 * @access	public
	 * @category Financial Functions
	 * @param	float	cost		Initial cost of the company.
	 * @param	float	salvage		Value at the end of the depreciation.
	 *								(Sometimes called the salvage value of the company)
	 * @param	integer	life		Number of periods over which the company is depreciated.
	 *								(Sometimes called the useful life of the company)
	 ...
	 * SLN
	 *
	 * Returns the straight-line depreciation of an company for one period
	 *
	 * @param	cost		Initial cost of the company
	 * @param	salvage		Value at the end of the depreciation
	 * @param	life		Number of periods over which the company is depreciated
	 * @return	float
	 */
	 ...
	 * SYD
	 *
	 * Returns the sum-of-years' digits depreciation of an company for a specified period.
	 *
	 * @param	cost		Initial cost of the company
	 * @param	salvage		Value at the end of the depreciation
	 * @param	life		Number of periods over which the company is depreciated
