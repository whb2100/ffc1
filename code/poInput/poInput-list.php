		...
		<div class="set_subnav"> 
			<div class="set_subnav_all">
				<div class="set_subnav_left">
					<ul>
						<li>
							...
							<span><input class="easyui-textbox" type="text" style="height:35px;" name="" id="aaaaaa"></span>
						</li>
						<li>
							<p><?php echo REGION?></p>
				...
				<div class="set_subnav_button" style="display:none">
					...
					<span><a href="javascript:void(0)" onclick="createItem()"><em><img src="../images/icon_type.png"/></em><?php echo PRINT_ITEM?></a></span>
				</div>
			</div>
		</div>
		<iframe id="batchIframe" src="poInput-create.php" style="width: 100%;height: 94%;display:block;min-height: 500px;margin-left:0px;"></iframe>
